        ...
        <Flex m="0 auto" w="100%" pos="relative" mb="20">
            <Stack w="100%"  m="0 auto" p={["0", "auto" ]} py="24" px="0" color="white" spacing="0">
                    <Slider {...settings}>
                        ...
                        <ServiceItem h="480px" overflow={"hidden"} title="Renda com Aluguéis" subtitle="Renda com Aluguéis" cover="./images/sl_predio.jpg">
                        ...
                        <ServiceItem h="480px" overflow={"hidden"} title="Planos de Consórcio" subtitle="Consultoria Financeira" cover="./images/sl_freela.jpg">
